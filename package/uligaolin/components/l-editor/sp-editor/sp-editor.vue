...
<view class="wrapper">
    ...
    <view style="background:linear-gradient(90deg, #40aff4, #199bfd 100%, #ff424e 0);border-radius:12rpx;color:white;text-align: center;line-height:70rpx;margin-top:30rpx;" @click="submit">提交</view>
</view>
</template>
...
.iconfont { display: inline-block; padding: 16rpx 16rpx; width: 46rpx; height: 46rpx; cursor: pointer; font-size: 20px; }
