...
<style scoped>
.popup{background: rgba(0,0,0,0.5); bottom: 0; position: fixed; width: 100vh; height: 100vh;}
.body{width:100%;height:100%;box-sizing:border-box;position:fixed;bottom:0;}
